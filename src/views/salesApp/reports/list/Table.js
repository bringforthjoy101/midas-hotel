...
const ReportsTable = () => {
	...
	const printReport = (sampleData, startDate, endDate) => {
		...
		printWindow.document.write('<h2>KLOFT HOTELS</h2>')
		printWindow.document.write('<p>Address: Oba Ile, Akure.</p>')
		printWindow.document.write('<p>Contact: 07067869400, 07067869400</p>')
